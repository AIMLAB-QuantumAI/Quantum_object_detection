...
class Compute_Loss(nn.Module):
    ...
    def forward(self, outputs, tg):
        ...
        tg_hm_cen =tg['hm_cen']
        out_hm_cen =outputs['hm_cen']
        #print(f'key of tg {tg_keys}')
        #print(f'key of tg {tg.values()}')
        #print(f'hm_cen of key {tg_hm_cen}')
        #print(f'hm_cen of key {tg_hm_cen.shape}')
        #print(f'hm_cen of out {out_hm_cen}')
        #print(f'hm_cen of out {out_hm_cen.shape}')
        outputs['hm_cen'] = _sigmoid(outputs['hm_cen'])
        outputs['cen_offset'] = _sigmoid(outputs['cen_offset'])

        l_hm_cen = self.focal_loss(outputs['hm_cen'], tg['hm_cen'])
        
        #print(f'focal loss  {l_hm_cen}')
        #print(f'focal loss  {l_hm_cen.shape}')
