...
from models.qcnn_utils import create_model # to import QCNN model
...
def parse_test_configs():
    ...
    ####################################################################
    configs.root_dir = '../'
    configs.dataset_dir = os.path.join('/mnt', 'kitti')
...
if __name__ == '__main__':
    ...
    model =torch.load(torch.load(configs.pretrained_path, map_location='cpu'))
